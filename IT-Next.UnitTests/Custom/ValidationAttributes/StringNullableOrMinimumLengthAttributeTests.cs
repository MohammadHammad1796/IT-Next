...
[TestFixture]
internal class StringNullableOrMinimumLengthAttributeTests
{
    private StringNullableOrMinimumLengthAttribute _attribute;
    ...
    public void Setup()
    {
        _attribute = new StringNullableOrMinimumLengthAttribute(2);
